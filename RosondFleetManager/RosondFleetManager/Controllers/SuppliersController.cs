...
namespace RosondFleetManager.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SupplierId,Name,ContactInfo")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SupplierId,Name,ContactInfo")] Supplier supplier)
        {
            if (ModelState.IsValid)
            {
